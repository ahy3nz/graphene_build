...
#all_dirs = [thing for thing in os.listdir() if os.path.isdir(thing) and 'pycache' not in thing]
constants = ['125']
angles = ['15' ,'30', '45']
trials = ['a', 'b', 'c']
#all_dirs = [thing for thing in os.listdir() if os.path.isdir(thing) and ('k100_' in thing or 'k50_' in thing or 'k125_' in thing)]
curr_dir = os.getcwd()
#for thing in all_dirs:
for combo in itertools.product(constants, angles, trials):
    thing = 'k{}_{}_{}'.format(combo[0], combo[1], combo[2])
