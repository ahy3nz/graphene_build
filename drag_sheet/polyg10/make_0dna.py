...
import script_utils
import operations
input_dir = '/raid6/homes/ahy3nz/Trajectories/charmm/polyg10/inputs/0dna'
    ...
    for constant in constants:
        for trial in trials:
            change_dir = os.path.join(
                    base_dir, '0dna', 'k{}_{}'.format(constant,trial))
            ...
            with open('submit.pbs', 'w') as f:
                ...
                script_utils.write_rahman_script(f, 
                        jobname='0dna_k{}_{}'.format(constant,trial),
                        body=lines)
...
pull-coord1-origin = 4.26 7.780 -0.22
pull-coord1-rate = 0
pull-coord1-k = {k}
