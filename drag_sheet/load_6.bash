...
export ANGLE=45
export FORCE=1000
export output_dir='6_dna/k1000_45_c'

export correct_top='6_dna.top'
mkdir -p ${output_dir}
mkdir -p ${GF}
...
gmx editconf -f ${GF}/dna-top3.gro -translate 6 5 0 -o ${GF}/dna-top3.gro
...
gmx editconf -f ${GF}/dna-bottom3.gro -translate 6 7 0 -o ${GF}/dna-bottom3.gro
